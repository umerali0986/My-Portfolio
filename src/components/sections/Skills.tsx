...
const Skills = () => {
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: "HTML/CSS", level: 95, years: "5+ years" },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Express.js", level: 90, years: "4+ years" },
        { name: "Django", level: 75, years: "2+ years" },
        { name: "GraphQL", level: 80, years: "2+ years" },
        { name: "REST APIs", level: 95, years: "4+ years" }
      ]
    },
    {
      ...
      skills: [
        ...
        { name: "Google Cloud", level: 75, years: "1+ year" },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Figma", level: 70, years: "2+ years" },
        { name: "Agile/Scrum", level: 90, years: "3+ years" },
  ...
  const technologies = [
    ...
    "Python", "Express.js", "Django", "MongoDB", "PostgreSQL", "AWS", 
    "Docker", "Git", "GraphQL", "REST API", "Tailwind CSS", "Sass",
    "Jest", "Webpack", "Vite", "Firebase", "Supabase", "Vercel"
  ];
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {technologies.map((tech, index) => (
              <Badge 
                key={index} 
                variant="outline" 
                className="skill-badge text-sm py-2 px-4 border-primary/30 text-foreground hover:bg-primary/10 hover:border-primary/50"
              >
                {tech}
              </Badge>
            ))}
